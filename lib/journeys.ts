...
export const CREATION_JOURNEYS: CreationJourney[] = [
  {
    ...
    title: 'Feter',
    homeDescription:
      "Raconter l'histoire de quelqu'un pour celebrer une naissance, un anniversaire, un depart a la retraite...",
    ctaLabel: 'Creer un espace de celebration',
  ...
  },
  {
    ...
    title: 'Transmettre',
    homeDescription: 'Creer son espace biographique, raconter sa vie, ses objets, ses patrimoines a leguer.',
    ctaLabel: 'Raconter ses memoires',
  ...
  },
  {
    ...
    communType: 'deces',
    title: 'Honorer',
    homeDescription: "Rendre hommage a une personne disparue avec dignite et pudeur.",
    ctaLabel: 'Creer un memorial',
