...
export const COMMUN_TYPES: CommunTypeConfig[] = [
  {
    ...
    subtitle: 'Memorial public pour un proche disparu',
    description: "Un espace digne et apaise pour raconter une vie et rassembler les hommages.",
  ...
  },
  {
    ...
    description: "Un commun positif pour celebrer une personne vivante.",
  ...
  },
  {
    ...
    subtitle: 'Parcours genealogique et recit de transmission',
    description: "Conserver les reperes familiaux, les anecdotes et les valeurs a transmettre.",
  ...
  {
    id: 'memoire-objet',
    title: 'Memoire d\'objet',
    subtitle: 'Objet, lieu, patrimoine affectif',
    description: "Donner une voix a un objet ou un lieu porteur de memoire.",
  ...
  {
    id: 'pro-ceremonie',
    title: 'Texte de ceremonie (Pro)',
    subtitle: 'Assistant redaction pour pompes funebres',
    description: "Aider les professionnels a rediger des textes de ceremonie avec tact et structure.",
    legacyContext: 'funeral',
    almaContext: 'honorer',
    category: 'pro',
  },
